...
# Custom CSS for video background with color blend
st.markdown("""
<style>
    /* Video background with color blend */
    .stApp {
        position: relative;
        background: #f5f1e8;
    }
    ...
    .bg-video {
        ...
        object-fit: cover;
        opacity: 0.35;
        filter: sepia(15%) saturate(85%) brightness(105%) hue-rotate(-5deg);
    }
    
    /* Color overlay to blend with UI palette */
    .stApp::after {
        content: '';
        position: fixed;
        top: 0;
...
<div class="bg-video-container">
    <video autoplay loop muted playsinline class="bg-video">
        <source src="/static/garden_bg.mp4" type="video/mp4">
    </video>
</div>
""", unsafe_allow_html=True)
